...
from casatasks import (
    ...
    gaincal, bandpass, fluxscale, applycal, split, tclean
)
...
def calibrate_vla_dataset(vis="day2_TDEM0003_10s_norx.ms", do_imaging=True):
    ...
    if do_imaging:
        print("\n=== Step 11: Make basic continuum image ===")
...
def main():
    ...
    calibrate_vla_dataset(vis=args.vis, do_imaging=not args.no_image)
